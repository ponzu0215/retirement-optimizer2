...
if "input_defaults" not in st.session_state:
    st.session_state.input_defaults = {
        "currentAge": "", "retirementAge": "", "joinAge": "",
        "severanceReceiveAge": "",
        "severancePay": "",
        "dcCurrentBalance": "", "dcMonthlyContribution": "", "dcReturnRate": "",
        "idecoStartAge": "", "idecoEndAge": "", "idecoCurrentBalance": "", "idecoMonthlyContribution": "", "idecoReturnRate": "",
        "avgSalary": "",
...
# ensure outer gradient remains visible (表示のみ)
st.markdown(
    """<style>
    /* ensure outer gradient from assets/styles.css is visible */
    div.block-container { background: transparent !important; }
    </style>""",
